# Comparing `tmp/extr-ds-0.0.83.tar.gz` & `tmp/extr-ds-0.0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "extr-ds-0.0.83.tar", last modified: Mon Jun  5 10:23:20 2023, max compression
+gzip compressed data, was "extr-ds-0.0.9.tar", last modified: Fri Apr 21 13:19:22 2023, max compression
```

## Comparing `extr-ds-0.0.83.tar` & `extr-ds-0.0.9.tar`

### file list

```diff
@@ -1,54 +1,20 @@
-drwxrwxrwx   0        0        0        0 2023-06-05 10:23:20.766692 extr-ds-0.0.83/
--rw-rw-rw-   0        0        0     5664 2023-06-05 10:23:20.757131 extr-ds-0.0.83/PKG-INFO
--rw-rw-rw-   0        0        0     3980 2023-05-19 21:13:57.000000 extr-ds-0.0.83/README.md
--rw-rw-rw-   0        0        0       42 2023-06-05 10:23:20.767999 extr-ds-0.0.83/setup.cfg
--rw-rw-rw-   0        0        0      704 2023-06-05 10:23:16.000000 extr-ds-0.0.83/setup.py
-drwxrwxrwx   0        0        0        0 2023-06-05 10:23:19.833669 extr-ds-0.0.83/src/
-drwxrwxrwx   0        0        0        0 2023-06-05 10:23:19.913976 extr-ds-0.0.83/src/extr_ds/
--rw-rw-rw-   0        0        0       27 2023-04-15 12:51:37.000000 extr-ds-0.0.83/src/extr_ds/__init__.py
-drwxrwxrwx   0        0        0        0 2023-06-05 10:23:20.134802 extr-ds-0.0.83/src/extr_ds/labelers/
--rw-rw-rw-   0        0        0       68 2023-04-16 10:14:54.000000 extr-ds-0.0.83/src/extr_ds/labelers/__init__.py
--rw-rw-rw-   0        0        0     1770 2023-05-23 10:41:41.000000 extr-ds-0.0.83/src/extr_ds/labelers/iob.py
--rw-rw-rw-   0        0        0     5922 2023-05-20 10:11:46.000000 extr-ds-0.0.83/src/extr_ds/labelers/relation.py
-drwxrwxrwx   0        0        0        0 2023-06-05 10:23:20.178640 extr-ds-0.0.83/src/extr_ds/manager/
--rw-rw-rw-   0        0        0       54 2023-04-30 12:32:24.000000 extr-ds-0.0.83/src/extr_ds/manager/__init__.py
--rw-rw-rw-   0        0        0     2927 2023-05-11 09:38:01.000000 extr-ds-0.0.83/src/extr_ds/manager/cmd.py
-drwxrwxrwx   0        0        0        0 2023-06-05 10:23:20.282544 extr-ds-0.0.83/src/extr_ds/manager/process/
--rw-rw-rw-   0        0        0      206 2023-05-11 09:37:51.000000 extr-ds-0.0.83/src/extr_ds/manager/process/__init__.py
-drwxrwxrwx   0        0        0        0 2023-06-05 10:23:20.405174 extr-ds-0.0.83/src/extr_ds/manager/process/entities/
--rw-rw-rw-   0        0        0       32 2023-05-11 09:09:26.000000 extr-ds-0.0.83/src/extr_ds/manager/process/entities/__init__.py
--rw-rw-rw-   0        0        0     2174 2023-05-19 19:35:35.000000 extr-ds-0.0.83/src/extr_ds/manager/process/entities/annotate.py
--rw-rw-rw-   0        0        0     1651 2023-05-18 15:49:38.000000 extr-ds-0.0.83/src/extr_ds/manager/process/entities/dev.py
--rw-rw-rw-   0        0        0      303 2023-05-11 09:05:39.000000 extr-ds-0.0.83/src/extr_ds/manager/process/entities/models.py
--rw-rw-rw-   0        0        0     1467 2023-05-11 10:06:35.000000 extr-ds-0.0.83/src/extr_ds/manager/process/how_to.py
-drwxrwxrwx   0        0        0        0 2023-06-05 10:23:20.474685 extr-ds-0.0.83/src/extr_ds/manager/process/relations/
--rw-rw-rw-   0        0        0       84 2023-05-11 08:53:28.000000 extr-ds-0.0.83/src/extr_ds/manager/process/relations/__init__.py
--rw-rw-rw-   0        0        0     2982 2023-05-18 19:37:35.000000 extr-ds-0.0.83/src/extr_ds/manager/process/relations/dev.py
--rw-rw-rw-   0        0        0     2008 2023-05-19 21:14:27.000000 extr-ds-0.0.83/src/extr_ds/manager/process/relations/relate.py
--rw-rw-rw-   0        0        0     5095 2023-05-19 14:42:46.000000 extr-ds-0.0.83/src/extr_ds/manager/process/save.py
--rw-rw-rw-   0        0        0      844 2023-05-05 10:11:23.000000 extr-ds-0.0.83/src/extr_ds/manager/process/split.py
--rw-rw-rw-   0        0        0     3096 2023-05-19 14:42:06.000000 extr-ds-0.0.83/src/extr_ds/manager/process/workspace.py
-drwxrwxrwx   0        0        0        0 2023-06-05 10:23:20.549406 extr-ds-0.0.83/src/extr_ds/manager/utils/
--rw-rw-rw-   0        0        0       91 2023-04-30 12:25:13.000000 extr-ds-0.0.83/src/extr_ds/manager/utils/__init__.py
--rw-rw-rw-   0        0        0     1476 2023-05-18 15:48:48.000000 extr-ds-0.0.83/src/extr_ds/manager/utils/filesystem.py
--rw-rw-rw-   0        0        0      494 2023-04-30 09:44:47.000000 extr-ds-0.0.83/src/extr_ds/manager/utils/imports.py
-drwxrwxrwx   0        0        0        0 2023-06-05 10:23:20.605154 extr-ds-0.0.83/src/extr_ds/models/
--rw-rw-rw-   0        0        0       42 2023-04-28 10:44:38.000000 extr-ds-0.0.83/src/extr_ds/models/__init__.py
--rw-rw-rw-   0        0        0     1411 2023-05-17 10:11:47.000000 extr-ds-0.0.83/src/extr_ds/models/labels.py
-drwxrwxrwx   0        0        0        0 2023-06-05 10:23:20.637134 extr-ds-0.0.83/src/extr_ds/rules/
--rw-rw-rw-   0        0        0       32 2023-06-05 10:02:55.000000 extr-ds-0.0.83/src/extr_ds/rules/__init__.py
--rw-rw-rw-   0        0        0      973 2023-06-05 10:17:54.000000 extr-ds-0.0.83/src/extr_ds/rules/majority.py
--rw-rw-rw-   0        0        0      217 2023-06-05 09:51:21.000000 extr-ds-0.0.83/src/extr_ds/rules/validators.py
-drwxrwxrwx   0        0        0        0 2023-06-05 10:23:20.700338 extr-ds-0.0.83/src/extr_ds/transformers/
--rw-rw-rw-   0        0        0       42 2023-05-05 10:03:32.000000 extr-ds-0.0.83/src/extr_ds/transformers/__init__.py
--rw-rw-rw-   0        0        0     2273 2023-05-19 13:19:31.000000 extr-ds-0.0.83/src/extr_ds/transformers/iob.py
-drwxrwxrwx   0        0        0        0 2023-06-05 10:23:20.754457 extr-ds-0.0.83/src/extr_ds/validators/
--rw-rw-rw-   0        0        0      174 2023-04-28 10:45:23.000000 extr-ds-0.0.83/src/extr_ds/validators/__init__.py
--rw-rw-rw-   0        0        0     1718 2023-04-28 10:43:16.000000 extr-ds-0.0.83/src/extr_ds/validators/differences.py
-drwxrwxrwx   0        0        0        0 2023-06-05 10:23:20.040845 extr-ds-0.0.83/src/extr_ds.egg-info/
--rw-rw-rw-   0        0        0     5664 2023-06-05 10:23:19.000000 extr-ds-0.0.83/src/extr_ds.egg-info/PKG-INFO
--rw-rw-rw-   0        0        0     1340 2023-06-05 10:23:19.000000 extr-ds-0.0.83/src/extr_ds.egg-info/SOURCES.txt
--rw-rw-rw-   0        0        0        1 2023-06-05 10:23:19.000000 extr-ds-0.0.83/src/extr_ds.egg-info/dependency_links.txt
--rw-rw-rw-   0        0        0       54 2023-06-05 10:23:19.000000 extr-ds-0.0.83/src/extr_ds.egg-info/entry_points.txt
--rw-rw-rw-   0        0        0       13 2023-06-05 10:23:19.000000 extr-ds-0.0.83/src/extr_ds.egg-info/requires.txt
--rw-rw-rw-   0        0        0        8 2023-06-05 10:23:19.000000 extr-ds-0.0.83/src/extr_ds.egg-info/top_level.txt
...
### Comparing `extr-ds-0.0.83/README.md` & `extr-ds-0.0.9/PKG-INFO`
...
### Comparing `extr-ds-0.0.83/setup.py` & `extr-ds-0.0.9/setup.py`
...
### Comparing `extr-ds-0.0.83/src/extr_ds/labelers/iob.py` & `extr-ds-0.0.9/src/extr_ds/labelers/iob.py`
...
### Comparing `extr-ds-0.0.83/src/extr_ds/validators/differences.py` & `extr-ds-0.0.9/src/extr_ds/validators.py`

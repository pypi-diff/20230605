# Comparing `tmp/watchmen_inquiry_surface-16.5.2.tar.gz` & `tmp/watchmen_inquiry_surface-16.5.3.tar.gz`
...
## Comparing `watchmen_inquiry_surface-16.5.2.tar` & `watchmen_inquiry_surface-16.5.3.tar`
...
### Comparing `watchmen_inquiry_surface-16.5.2/LICENSE` & `watchmen_inquiry_surface-16.5.3/LICENSE`

 * *Files identical despite different names*

### Comparing `watchmen_inquiry_surface-16.5.2/pyproject.toml` & `watchmen_inquiry_surface-16.5.3/pyproject.toml`
...
### Comparing `watchmen_inquiry_surface-16.5.2/src/watchmen_inquiry_surface/data/data_router.py` & `watchmen_inquiry_surface-16.5.3/src/watchmen_inquiry_surface/data/data_router.py`

 * *Files identical despite different names*

### Comparing `watchmen_inquiry_surface-16.5.2/PKG-INFO` & `watchmen_inquiry_surface-16.5.3/PKG-INFO`

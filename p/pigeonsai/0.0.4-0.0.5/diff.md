# Comparing `tmp/pigeonsai-0.0.4.tar.gz` & `tmp/pigeonsai-0.0.5.tar.gz`
...
+gzip compressed data, was "pigeonsai-0.0.5.tar", last modified: Sun Jun  4 22:40:18 2023, max compression
```

## Comparing `pigeonsai-0.0.4.tar` & `pigeonsai-0.0.5.tar`
...
+drwxr-xr-x   0 ariaattar   (501) staff       (20)        0 2023-06-04 22:40:18.248450 pigeonsai-0.0.5/
+-rw-r--r--   0 ariaattar   (501) staff       (20)     2921 2023-06-04 22:40:18.248308 pigeonsai-0.0.5/PKG-INFO
+-rw-r--r--   0 ariaattar   (501) staff       (20)     1508 2023-06-03 00:14:17.000000 pigeonsai-0.0.5/README.md
+-rw-r--r--   0 ariaattar   (501) staff       (20)       38 2023-06-04 22:40:18.248495 pigeonsai-0.0.5/setup.cfg
+-rw-r--r--   0 ariaattar   (501) staff       (20)     2064 2023-06-04 22:40:09.000000 pigeonsai-0.0.5/setup.py
+drwxr-xr-x   0 ariaattar   (501) staff       (20)        0 2023-06-04 22:40:18.246436 pigeonsai-0.0.5/src/
+drwxr-xr-x   0 ariaattar   (501) staff       (20)        0 2023-06-04 22:40:18.247193 pigeonsai-0.0.5/src/pigeonsai/
+-rw-r--r--   0 ariaattar   (501) staff       (20)       32 2023-06-03 00:01:24.000000 pigeonsai-0.0.5/src/pigeonsai/__init__.py
+-rw-r--r--   0 ariaattar   (501) staff       (20)     2480 2023-06-04 22:39:56.000000 pigeonsai-0.0.5/src/pigeonsai/pigeonsdb.py
+drwxr-xr-x   0 ariaattar   (501) staff       (20)        0 2023-06-04 22:40:18.247898 pigeonsai-0.0.5/src/pigeonsai.egg-info/
+-rw-r--r--   0 ariaattar   (501) staff       (20)     2921 2023-06-04 22:40:18.000000 pigeonsai-0.0.5/src/pigeonsai.egg-info/PKG-INFO
+-rw-r--r--   0 ariaattar   (501) staff       (20)      279 2023-06-04 22:40:18.000000 pigeonsai-0.0.5/src/pigeonsai.egg-info/SOURCES.txt
+-rw-r--r--   0 ariaattar   (501) staff       (20)        1 2023-06-04 22:40:18.000000 pigeonsai-0.0.5/src/pigeonsai.egg-info/dependency_links.txt
+-rw-r--r--   0 ariaattar   (501) staff       (20)       17 2023-06-04 22:40:18.000000 pigeonsai-0.0.5/src/pigeonsai.egg-info/requires.txt
+-rw-r--r--   0 ariaattar   (501) staff       (20)       10 2023-06-04 22:40:18.000000 pigeonsai-0.0.5/src/pigeonsai.egg-info/top_level.txt
+drwxr-xr-x   0 ariaattar   (501) staff       (20)        0 2023-06-04 22:40:18.248020 pigeonsai-0.0.5/tests/
+-rw-r--r--   0 ariaattar   (501) staff       (20)      609 2023-06-02 23:54:25.000000 pigeonsai-0.0.5/tests/test_pigeonsdb.py
```

### Comparing `pigeonsai-0.0.4/PKG-INFO` & `pigeonsai-0.0.5/PKG-INFO`
...
### Comparing `pigeonsai-0.0.4/README.md` & `pigeonsai-0.0.5/README.md`

 * *Files identical despite different names*

### Comparing `pigeonsai-0.0.4/setup.py` & `pigeonsai-0.0.5/setup.py`
...
### Comparing `pigeonsai-0.0.4/src/pigeonsai/pigeonsdb.py` & `pigeonsai-0.0.5/src/pigeonsai/pigeonsdb.py`
...
### Comparing `pigeonsai-0.0.4/src/pigeonsai.egg-info/PKG-INFO` & `pigeonsai-0.0.5/src/pigeonsai.egg-info/PKG-INFO`
...
### Comparing `pigeonsai-0.0.4/tests/test_pigeonsdb.py` & `pigeonsai-0.0.5/tests/test_pigeonsdb.py`

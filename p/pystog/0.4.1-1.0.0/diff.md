# Comparing `tmp/pystog-0.4.1.tar.gz` & `tmp/pystog-1.0.0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "dist/pystog-0.4.1.tar", last modified: Sun Jun  4 23:01:36 2023, max compression
+gzip compressed data, was "dist/pystog-1.0.0.tar", last modified: Wed Dec 30 16:48:17 2020, max compression
```

## Comparing `pystog-0.4.1.tar` & `pystog-1.0.0.tar`

### file list

```diff
@@ -1,47 +1,44 @@
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-04 23:01:36.000000 pystog-0.4.1/
--rw-r--r--   0 runner    (1001) docker     (123)    35147 2023-06-04 22:57:01.000000 pystog-0.4.1/LICENSE
--rw-r--r--   0 runner    (1001) docker     (123)       75 2023-06-04 22:57:01.000000 pystog-0.4.1/MANIFEST.in
--rw-r--r--   0 runner    (1001) docker     (123)      607 2023-06-04 23:01:36.000000 pystog-0.4.1/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)     6495 2023-06-04 22:57:01.000000 pystog-0.4.1/README.md
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-04 23:01:36.000000 pystog-0.4.1/pystog/
--rw-r--r--   0 runner    (1001) docker     (123)      368 2023-06-04 22:57:01.000000 pystog-0.4.1/pystog/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)      497 2023-06-04 23:01:36.000000 pystog-0.4.1/pystog/_version.py
--rwxr-xr-x   0 runner    (1001) docker     (123)     2013 2023-06-04 22:57:01.000000 pystog-0.4.1/pystog/cli.py
--rw-r--r--   0 runner    (1001) docker     (123)    12616 2023-06-04 22:57:01.000000 pystog-0.4.1/pystog/converter.py
--rw-r--r--   0 runner    (1001) docker     (123)    20994 2023-06-04 22:57:01.000000 pystog-0.4.1/pystog/fourier_filter.py
--rw-r--r--   0 runner    (1001) docker     (123)     4513 2023-06-04 22:57:01.000000 pystog-0.4.1/pystog/io.py
--rw-r--r--   0 runner    (1001) docker     (123)     1663 2023-06-04 22:57:01.000000 pystog-0.4.1/pystog/pre_proc.py
--rw-r--r--   0 runner    (1001) docker     (123)    53289 2023-06-04 22:57:01.000000 pystog-0.4.1/pystog/stog.py
--rw-r--r--   0 runner    (1001) docker     (123)    25383 2023-06-04 22:57:01.000000 pystog-0.4.1/pystog/transformer.py
--rw-r--r--   0 runner    (1001) docker     (123)      795 2023-06-04 22:57:01.000000 pystog-0.4.1/pystog/utils.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-04 23:01:36.000000 pystog-0.4.1/pystog.egg-info/
--rw-r--r--   0 runner    (1001) docker     (123)      607 2023-06-04 23:01:35.000000 pystog-0.4.1/pystog.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      917 2023-06-04 23:01:35.000000 pystog-0.4.1/pystog.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-06-04 23:01:35.000000 pystog-0.4.1/pystog.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (123)       53 2023-06-04 23:01:35.000000 pystog-0.4.1/pystog.egg-info/entry_points.txt
--rw-r--r--   0 runner    (1001) docker     (123)       11 2023-06-04 23:01:35.000000 pystog-0.4.1/pystog.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (123)       13 2023-06-04 23:01:35.000000 pystog-0.4.1/pystog.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (123)       47 2023-06-04 22:57:01.000000 pystog-0.4.1/requirements-dev.txt
--rw-r--r--   0 runner    (1001) docker     (123)       10 2023-06-04 22:57:01.000000 pystog-0.4.1/requirements.txt
--rw-r--r--   0 runner    (1001) docker     (123)      262 2023-06-04 23:01:36.000000 pystog-0.4.1/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (123)     2079 2023-06-04 22:57:01.000000 pystog-0.4.1/setup.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-04 23:01:36.000000 pystog-0.4.1/tests/
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-06-04 22:57:01.000000 pystog-0.4.1/tests/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)      786 2023-06-04 22:57:01.000000 pystog-0.4.1/tests/create_test_files.py
--rw-r--r--   0 runner    (1001) docker     (123)     6453 2023-06-04 22:57:01.000000 pystog-0.4.1/tests/materials.py
--rw-r--r--   0 runner    (1001) docker     (123)      221 2023-06-04 22:57:01.000000 pystog-0.4.1/tests/test_cli.py
--rw-r--r--   0 runner    (1001) docker     (123)    15256 2023-06-04 22:57:01.000000 pystog-0.4.1/tests/test_converter.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-04 23:01:36.000000 pystog-0.4.1/tests/test_data/
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-06-04 22:57:01.000000 pystog-0.4.1/tests/test_data/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)    34234 2023-06-04 22:57:01.000000 pystog-0.4.1/tests/test_data/argon.gr
--rw-r--r--   0 runner    (1001) docker     (123)    48445 2023-06-04 22:57:01.000000 pystog-0.4.1/tests/test_data/argon.real_space.dat
--rw-r--r--   0 runner    (1001) docker     (123)    81850 2023-06-04 22:57:01.000000 pystog-0.4.1/tests/test_data/argon.reciprocal_space.dat
--rw-r--r--   0 runner    (1001) docker     (123)    12231 2023-06-04 22:57:01.000000 pystog-0.4.1/tests/test_data/nickel.gr
--rw-r--r--   0 runner    (1001) docker     (123)    18895 2023-06-04 22:57:01.000000 pystog-0.4.1/tests/test_data/nickel.real_space.dat
--rw-r--r--   0 runner    (1001) docker     (123)    88077 2023-06-04 22:57:01.000000 pystog-0.4.1/tests/test_data/nickel.reciprocal_space.dat
--rw-r--r--   0 runner    (1001) docker     (123)     8478 2023-06-04 22:57:01.000000 pystog-0.4.1/tests/test_fourier_filter.py
--rw-r--r--   0 runner    (1001) docker     (123)     2519 2023-06-04 22:57:01.000000 pystog-0.4.1/tests/test_io.py
--rw-r--r--   0 runner    (1001) docker     (123)    45909 2023-06-04 22:57:01.000000 pystog-0.4.1/tests/test_stog.py
--rw-r--r--   0 runner    (1001) docker     (123)    17881 2023-06-04 22:57:01.000000 pystog-0.4.1/tests/test_transformer.py
--rw-r--r--   0 runner    (1001) docker     (123)     4345 2023-06-04 22:57:01.000000 pystog-0.4.1/tests/utils.py
--rw-r--r--   0 runner    (1001) docker     (123)    68632 2023-06-04 22:57:01.000000 pystog-0.4.1/versioneer.py
...
### Comparing `pystog-0.4.1/PKG-INFO` & `pystog-1.0.0/PKG-INFO`
...
### Comparing `pystog-0.4.1/README.md` & `pystog-1.0.0/README.md`
...
### Comparing `pystog-0.4.1/pystog/converter.py` & `pystog-1.0.0/pystog/converter.py`
...
### Comparing `pystog-0.4.1/pystog/fourier_filter.py` & `pystog-1.0.0/pystog/fourier_filter.py`
...
### Comparing `pystog-0.4.1/pystog/io.py` & `pystog-1.0.0/pystog/io.py`
...
### Comparing `pystog-0.4.1/pystog/stog.py` & `pystog-1.0.0/pystog/stog.py`
...
### Comparing `pystog-0.4.1/pystog/transformer.py` & `pystog-1.0.0/pystog/transformer.py`
...
### Comparing `pystog-0.4.1/pystog/utils.py` & `pystog-1.0.0/pystog/utils.py`

 * *Files identical despite different names*

### Comparing `pystog-0.4.1/pystog.egg-info/PKG-INFO` & `pystog-1.0.0/pystog.egg-info/PKG-INFO`
...
### Comparing `pystog-0.4.1/pystog.egg-info/SOURCES.txt` & `pystog-1.0.0/pystog.egg-info/SOURCES.txt`
...
### Comparing `pystog-0.4.1/setup.py` & `pystog-1.0.0/setup.py`
...
### Comparing `pystog-0.4.1/tests/create_test_files.py` & `pystog-1.0.0/tests/create_test_files.py`

 * *Files identical despite different names*

### Comparing `pystog-0.4.1/tests/materials.py` & `pystog-1.0.0/tests/materials.py`

 * *Files identical despite different names*

### Comparing `pystog-0.4.1/tests/test_converter.py` & `pystog-1.0.0/tests/test_converter.py`
...
### Comparing `pystog-0.4.1/tests/test_data/argon.gr` & `pystog-1.0.0/tests/test_data/argon.gr`

 * *Files identical despite different names*

### Comparing `pystog-0.4.1/tests/test_data/argon.real_space.dat` & `pystog-1.0.0/tests/test_data/argon.real_space.dat`

 * *Files identical despite different names*

### Comparing `pystog-0.4.1/tests/test_data/argon.reciprocal_space.dat` & `pystog-1.0.0/tests/test_data/argon.reciprocal_space.dat`

 * *Files identical despite different names*

### Comparing `pystog-0.4.1/tests/test_data/nickel.gr` & `pystog-1.0.0/tests/test_data/nickel.gr`

 * *Files identical despite different names*

### Comparing `pystog-0.4.1/tests/test_data/nickel.real_space.dat` & `pystog-1.0.0/tests/test_data/nickel.real_space.dat`

 * *Files identical despite different names*

### Comparing `pystog-0.4.1/tests/test_data/nickel.reciprocal_space.dat` & `pystog-1.0.0/tests/test_data/nickel.reciprocal_space.dat`

 * *Files identical despite different names*

### Comparing `pystog-0.4.1/tests/test_fourier_filter.py` & `pystog-1.0.0/tests/test_fourier_filter.py`

 * *Files identical despite different names*

### Comparing `pystog-0.4.1/tests/test_stog.py` & `pystog-1.0.0/tests/test_stog.py`
...
### Comparing `pystog-0.4.1/tests/test_transformer.py` & `pystog-1.0.0/tests/test_transformer.py`

 * *Files identical despite different names*

### Comparing `pystog-0.4.1/tests/utils.py` & `pystog-1.0.0/tests/utils.py`
...
### Comparing `pystog-0.4.1/versioneer.py` & `pystog-1.0.0/versioneer.py`

# Comparing `tmp/python-selve-new-2.2.5.tar.gz` & `tmp/python-selve-new-2.2.6.tar.gz`
...
### Comparing `python-selve-new-2.2.5/PKG-INFO` & `python-selve-new-2.2.6/PKG-INFO`

# Comparing `tmp/python-selve-new-2.2.3.tar.gz` & `tmp/python-selve-new-2.2.4.tar.gz`
...
### Comparing `python-selve-new-2.2.3/PKG-INFO` & `python-selve-new-2.2.4/PKG-INFO`

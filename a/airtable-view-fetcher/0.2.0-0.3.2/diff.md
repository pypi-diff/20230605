# Comparing `tmp/airtable_view_fetcher-0.2.0.tar.gz` & `tmp/airtable_view_fetcher-0.3.2.tar.gz`
...
## Comparing `airtable_view_fetcher-0.2.0.tar` & `airtable_view_fetcher-0.3.2.tar`
...
### Comparing `airtable_view_fetcher-0.2.0/LICENSE` & `airtable_view_fetcher-0.3.2/LICENSE`

 * *Files identical despite different names*

### Comparing `airtable_view_fetcher-0.2.0/README.md` & `airtable_view_fetcher-0.3.2/README.md`

 * *Files identical despite different names*

### Comparing `airtable_view_fetcher-0.2.0/airtable_view_fetcher/fetch_airtable_data.py` & `airtable_view_fetcher-0.3.2/airtable_view_fetcher/fetch_airtable_data.py`

 * *Files identical despite different names*

### Comparing `airtable_view_fetcher-0.2.0/setup.py` & `airtable_view_fetcher-0.3.2/setup.py`

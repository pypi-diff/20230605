# Comparing `tmp/telegramweb-4.9.tar.gz` & `tmp/telegramweb-5.1.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "telegramweb-4.9.tar", last modified: Mon Jun  5 06:37:33 2023, max compression
+gzip compressed data, was "telegramweb-5.1.tar", last modified: Mon Jun  5 07:24:09 2023, max compression
```

## Comparing `telegramweb-4.9.tar` & `telegramweb-5.1.tar`

### file list

```diff
@@ -1,23 +1,23 @@
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-05 06:37:33.500107 telegramweb-4.9/
--rw-r--r--   0 runner    (1001) docker     (123)     1062 2023-06-05 06:37:15.000000 telegramweb-4.9/LICENSE
--rw-r--r--   0 runner    (1001) docker     (123)       63 2023-06-05 06:37:15.000000 telegramweb-4.9/MANIFEST.in
--rw-r--r--   0 runner    (1001) docker     (123)    10321 2023-06-05 06:37:33.500107 telegramweb-4.9/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)     9403 2023-06-05 06:37:15.000000 telegramweb-4.9/README.md
--rw-r--r--   0 runner    (1001) docker     (123)       38 2023-06-05 06:37:33.500107 telegramweb-4.9/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (123)     1303 2023-06-05 06:37:15.000000 telegramweb-4.9/setup.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-05 06:37:33.496107 telegramweb-4.9/telegram_news/
--rw-r--r--   0 runner    (1001) docker     (123)      559 2023-06-05 06:37:15.000000 telegramweb-4.9/telegram_news/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)     1636 2023-06-05 06:37:15.000000 telegramweb-4.9/telegram_news/constant.py
--rw-r--r--   0 runner    (1001) docker     (123)     4135 2023-06-05 06:37:15.000000 telegramweb-4.9/telegram_news/displaypolicy.py
--rw-r--r--   0 runner    (1001) docker     (123)     4944 2023-06-05 06:37:15.000000 telegramweb-4.9/telegram_news/ratelimit.py
--rw-r--r--   0 runner    (1001) docker     (123)      106 2023-06-05 06:37:15.000000 telegramweb-4.9/telegram_news/table.sql
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-05 06:37:33.496107 telegramweb-4.9/telegram_news/template/
--rw-r--r--   0 runner    (1001) docker     (123)      391 2023-06-05 06:37:15.000000 telegramweb-4.9/telegram_news/template/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)    44162 2023-06-05 06:37:15.000000 telegramweb-4.9/telegram_news/template/common.py
--rw-r--r--   0 runner    (1001) docker     (123)    17293 2023-06-05 06:37:15.000000 telegramweb-4.9/telegram_news/utils.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-05 06:37:33.496107 telegramweb-4.9/telegramweb.egg-info/
--rw-r--r--   0 runner    (1001) docker     (123)    10321 2023-06-05 06:37:33.000000 telegramweb-4.9/telegramweb.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      437 2023-06-05 06:37:33.000000 telegramweb-4.9/telegramweb.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-06-05 06:37:33.000000 telegramweb-4.9/telegramweb.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (123)       66 2023-06-05 06:37:33.000000 telegramweb-4.9/telegramweb.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (123)       14 2023-06-05 06:37:33.000000 telegramweb-4.9/telegramweb.egg-info/top_level.txt
...
### Comparing `telegramweb-4.9/LICENSE` & `telegramweb-5.1/LICENSE`

 * *Files identical despite different names*

### Comparing `telegramweb-4.9/PKG-INFO` & `telegramweb-5.1/README.md`
...
### Comparing `telegramweb-4.9/README.md` & `telegramweb-5.1/PKG-INFO`
...
+00000030: 2035 2e31 0a53 756d 6d61 7279 3a20 5079   5.1.Summary: Py
...
### Comparing `telegramweb-4.9/setup.py` & `telegramweb-5.1/setup.py`
...
### Comparing `telegramweb-4.9/telegram_news/__init__.py` & `telegramweb-5.1/telegram_news/__init__.py`

 * *Files identical despite different names*

### Comparing `telegramweb-4.9/telegram_news/constant.py` & `telegramweb-5.1/telegram_news/constant.py`

 * *Files identical despite different names*

### Comparing `telegramweb-4.9/telegram_news/displaypolicy.py` & `telegramweb-5.1/telegram_news/displaypolicy.py`
...
-def default_policy(item, self, tag='', max_len=1000, max_par_num=40):
...
@@ -53,45 +53,47 @@
     ...
     if item['link']:
-        po += '<a href=\"' + item['link'] + '\">LATEST UPDATE FROM ' + self._tag + ' SECTION</a>'
...
-def best_effort_display_policy(item, self, tag='', max_len=1000, max_par_num=40, suffix='...'):
...
-           '[' + item['source'] + ']' + '<a href=\"' + item['link'] + '\">LATEST UPDATE FROM ' + self._tag + ' SECTION</a>' + ' '
...
### Comparing `telegramweb-4.9/telegram_news/ratelimit.py` & `telegramweb-5.1/telegram_news/ratelimit.py`

 * *Files identical despite different names*

### Comparing `telegramweb-4.9/telegram_news/template/common.py` & `telegramweb-5.1/telegram_news/template/common.py`

 * *Files identical despite different names*

### Comparing `telegramweb-4.9/telegram_news/utils.py` & `telegramweb-5.1/telegram_news/utils.py`

 * *Files identical despite different names*

### Comparing `telegramweb-4.9/telegramweb.egg-info/PKG-INFO` & `telegramweb-5.1/telegramweb.egg-info/PKG-INFO`
...
@@ -1,646 +1,778 @@
 ...
 00000010: 3a20 322e 310a 4e61 6d65 3a20 7465 6c65  : 2.1.Name: tele
 00000020: 6772 616d 7765 620a 5665 7273 696f 6e3a  gramweb.Version:
-00000030: 2034 2e39 0a53 756d 6d61 7279 3a20 5079   4.9.Summary: Py
+00000030: 2035 2e31 0a53 756d 6d61 7279 3a20 5079   5.1.Summary: Py
 00000040: 7468 6f6e 2070 6163 6b61 6765 2066 6f72  thon package for
 00000050: 2061 7574 6f6d 6174 6963 616c 6c79 2066   automatically f
 00000060: 6574 6368 696e 6720 616e 6420 7075 7368  etching and push

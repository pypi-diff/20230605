# Comparing `tmp/textbsr-0.1.3.tar.gz` & `tmp/textbsr-0.1.4.tar.gz`
...
## Comparing `textbsr-0.1.3.tar` & `textbsr-0.1.4.tar`
...
### Comparing `textbsr-0.1.3/PKG-INFO` & `textbsr-0.1.4/PKG-INFO`
...
### Comparing `textbsr-0.1.3/README.md` & `textbsr-0.1.4/README.md`

 * *Files identical despite different names*

### Comparing `textbsr-0.1.3/setup.py` & `textbsr-0.1.4/setup.py`
...
### Comparing `textbsr-0.1.3/textbsr/models/TextEnhancement.py` & `textbsr-0.1.4/textbsr/models/TextEnhancement.py`

 * *Files identical despite different names*

### Comparing `textbsr-0.1.3/textbsr/textbsr.py` & `textbsr-0.1.4/textbsr/textbsr.py`

 * *Files identical despite different names*

### Comparing `textbsr-0.1.3/textbsr/utils/utils_image.py` & `textbsr-0.1.4/textbsr/utils/utils_image.py`

 * *Files identical despite different names*

### Comparing `textbsr-0.1.3/textbsr.egg-info/PKG-INFO` & `textbsr-0.1.4/textbsr.egg-info/PKG-INFO`

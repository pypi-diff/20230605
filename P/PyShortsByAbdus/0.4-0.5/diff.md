# Comparing `tmp/PyShortsByAbdus-0.4.tar.gz` & `tmp/PyShortsByAbdus-0.5.tar.gz`
...
## Comparing `PyShortsByAbdus-0.4.tar` & `PyShortsByAbdus-0.5.tar`
...
### Comparing `PyShortsByAbdus-0.4/PKG-INFO` & `PyShortsByAbdus-0.5/PKG-INFO`
...
### Comparing `PyShortsByAbdus-0.4/PyShorts/Sub_Functions/funcs.py` & `PyShortsByAbdus-0.5/pyshorts/funcs.py`
...
@@ -1,11 +1,11 @@
 ...
 import requests
 import random
-from Sub_Functions.non_use_funcs import (
...
### Comparing `PyShortsByAbdus-0.4/PyShorts/Sub_Functions/non_use_funcs.py` & `PyShortsByAbdus-0.5/pyshorts/non_use_funcs.py`

 * *Files identical despite different names*

### Comparing `PyShortsByAbdus-0.4/PyShortsByAbdus.egg-info/PKG-INFO` & `PyShortsByAbdus-0.5/PyShortsByAbdus.egg-info/PKG-INFO`
...
### Comparing `PyShortsByAbdus-0.4/setup.py` & `PyShortsByAbdus-0.5/setup.py`

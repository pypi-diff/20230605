# Comparing `tmp/msaBase-0.0.87.tar.gz` & `tmp/msaBase-0.0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "msaBase-0.0.87.tar", last modified: Mon Jun  5 07:32:35 2023, max compression
+gzip compressed data, was "msaBase-0.0.9.tar", last modified: Thu Nov 24 17:12:13 2022, max compression
```

## Comparing `msaBase-0.0.87.tar` & `msaBase-0.0.9.tar`

### file list

```diff
@@ -1,33 +1,32 @@
-drwxrwxr-x   0 vitaly    (1000) vitaly    (1000)        0 2023-06-05 07:32:35.041418 msaBase-0.0.87/
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)     1094 2023-03-26 10:37:44.000000 msaBase-0.0.87/LICENCE
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)       58 2023-03-26 10:37:44.000000 msaBase-0.0.87/MANIFEST.in
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)     4135 2023-06-05 07:32:35.041418 msaBase-0.0.87/PKG-INFO
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)     2689 2023-03-26 10:37:44.000000 msaBase-0.0.87/README.md
-drwxrwxr-x   0 vitaly    (1000) vitaly    (1000)        0 2023-06-05 07:32:35.041418 msaBase-0.0.87/msaBase/
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)      472 2023-06-05 06:48:31.000000 msaBase-0.0.87/msaBase/__init__.py
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)     8182 2023-05-31 07:36:42.000000 msaBase-0.0.87/msaBase/config.py
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)    36887 2023-06-05 07:32:12.000000 msaBase-0.0.87/msaBase/configurate.py
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)     2116 2023-04-21 08:06:10.000000 msaBase-0.0.87/msaBase/errorhandling.py
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)     2930 2023-05-31 08:30:19.000000 msaBase-0.0.87/msaBase/helpers.py
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)     3720 2023-04-21 08:06:10.000000 msaBase-0.0.87/msaBase/logger.py
-drwxrwxr-x   0 vitaly    (1000) vitaly    (1000)        0 2023-06-05 07:32:35.041418 msaBase-0.0.87/msaBase/models/
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)      211 2023-04-21 08:06:10.000000 msaBase-0.0.87/msaBase/models/__init__.py
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)      948 2023-04-04 06:43:14.000000 msaBase-0.0.87/msaBase/models/functionality.py
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)     1414 2023-03-26 10:37:44.000000 msaBase-0.0.87/msaBase/models/middlewares.py
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)      381 2023-03-26 10:37:44.000000 msaBase-0.0.87/msaBase/models/settings.py
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)    14964 2023-05-01 07:24:39.000000 msaBase-0.0.87/msaBase/models/sysinfo.py
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)     4785 2023-05-11 16:54:40.000000 msaBase-0.0.87/msaBase/profiler.py
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)    14841 2023-05-11 16:54:40.000000 msaBase-0.0.87/msaBase/sysinfo.py
-drwxrwxr-x   0 vitaly    (1000) vitaly    (1000)        0 2023-06-05 07:32:35.041418 msaBase-0.0.87/msaBase/utils/
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)        0 2023-03-26 10:37:44.000000 msaBase-0.0.87/msaBase/utils/__init__.py
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)      338 2023-05-31 07:36:42.000000 msaBase-0.0.87/msaBase/utils/constants.py
-drwxrwxr-x   0 vitaly    (1000) vitaly    (1000)        0 2023-06-05 07:32:35.041418 msaBase-0.0.87/msaBase.egg-info/
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)     4135 2023-06-05 07:32:35.000000 msaBase-0.0.87/msaBase.egg-info/PKG-INFO
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)      592 2023-06-05 07:32:35.000000 msaBase-0.0.87/msaBase.egg-info/SOURCES.txt
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)        1 2023-06-05 07:32:35.000000 msaBase-0.0.87/msaBase.egg-info/dependency_links.txt
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)      808 2023-06-05 07:32:35.000000 msaBase-0.0.87/msaBase.egg-info/requires.txt
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)        8 2023-06-05 07:32:35.000000 msaBase-0.0.87/msaBase.egg-info/top_level.txt
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)        1 2023-03-31 07:37:42.000000 msaBase-0.0.87/msaBase.egg-info/zip-safe
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)     3878 2023-06-01 09:05:52.000000 msaBase-0.0.87/requirements.txt
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)       38 2023-06-05 07:32:35.041418 msaBase-0.0.87/setup.cfg
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)     2312 2023-04-21 08:06:10.000000 msaBase-0.0.87/setup.py
...
### Comparing `msaBase-0.0.87/LICENCE` & `msaBase-0.0.9/LICENCE`

 * *Files identical despite different names*

### Comparing `msaBase-0.0.87/PKG-INFO` & `msaBase-0.0.9/PKG-INFO`
...
```diff
@@ -1,26 +1,27 @@
-Metadata-Version: 2.1 Name: msaBase Version: 0.0.87 Summary: msaBase - General
...
### Comparing `msaBase-0.0.87/README.md` & `msaBase-0.0.9/README.md`

 * *Files identical despite different names*

### Comparing `msaBase-0.0.87/msaBase/config.py` & `msaBase-0.0.9/msaBase/config.py`
...
### Comparing `msaBase-0.0.87/msaBase/configurate.py` & `msaBase-0.0.9/msaBase/configurate.py`
...
### Comparing `msaBase-0.0.87/msaBase/errorhandling.py` & `msaBase-0.0.9/msaBase/errorhandling.py`
...
### Comparing `msaBase-0.0.87/msaBase/logger.py` & `msaBase-0.0.9/msaBase/logger.py`
...
### Comparing `msaBase-0.0.87/msaBase/profiler.py` & `msaBase-0.0.9/msaBase/profiler.py`
...
### Comparing `msaBase-0.0.87/msaBase/sysinfo.py` & `msaBase-0.0.9/msaBase/sysinfo.py`
...
### Comparing `msaBase-0.0.87/msaBase.egg-info/PKG-INFO` & `msaBase-0.0.9/msaBase.egg-info/PKG-INFO`
...
### Comparing `msaBase-0.0.87/msaBase.egg-info/SOURCES.txt` & `msaBase-0.0.9/msaBase.egg-info/SOURCES.txt`
...
### Comparing `msaBase-0.0.87/requirements.txt` & `msaBase-0.0.9/requirements.txt`
...
### Comparing `msaBase-0.0.87/setup.py` & `msaBase-0.0.9/setup.py`

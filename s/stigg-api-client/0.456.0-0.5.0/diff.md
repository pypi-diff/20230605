# Comparing `tmp/stigg_api_client-0.456.0.tar.gz` & `tmp/stigg_api_client-0.5.0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "stigg_api_client-0.456.0.tar", max compression
+gzip compressed data, was "stigg_api_client-0.5.0.tar", max compression
```

## Comparing `stigg_api_client-0.456.0.tar` & `stigg_api_client-0.5.0.tar`

### file list

```diff
@@ -1,8 +1,8 @@
--rw-r--r--   0        0        0     2479 2023-06-05 08:16:27.629982 stigg_api_client-0.456.0/README.md
--rw-r--r--   0        0        0      460 2023-06-05 08:17:03.899394 stigg_api_client-0.456.0/pyproject.toml
--rw-r--r--   0        0        0       44 2023-06-05 08:16:27.629982 stigg_api_client-0.456.0/stigg/__init__.py
--rw-r--r--   0        0        0     1141 2023-06-05 08:16:27.629982 stigg_api_client-0.456.0/stigg/client.py
--rw-r--r--   0        0        0        0 2023-06-05 08:17:01.947318 stigg_api_client-0.456.0/stigg/generated/__init__.py
--rw-r--r--   0        0        0    46503 2023-06-05 08:17:02.371334 stigg_api_client-0.456.0/stigg/generated/operations.py
--rw-r--r--   0        0        0   460536 2023-06-05 08:17:02.215328 stigg_api_client-0.456.0/stigg/generated/schema.py
--rw-r--r--   0        0        0     3081 1970-01-01 00:00:00.000000 stigg_api_client-0.456.0/PKG-INFO
...
### Comparing `stigg_api_client-0.456.0/README.md` & `stigg_api_client-0.5.0/README.md`

 * *Files identical despite different names*

### Comparing `stigg_api_client-0.456.0/stigg/client.py` & `stigg_api_client-0.5.0/stigg/client.py`

 * *Files identical despite different names*

### Comparing `stigg_api_client-0.456.0/stigg/generated/operations.py` & `stigg_api_client-0.5.0/stigg/generated/operations.py`
...
### Comparing `stigg_api_client-0.456.0/stigg/generated/schema.py` & `stigg_api_client-0.5.0/stigg/generated/schema.py`
...
-    __schema__ = schema
-    __field_names__ = ('feature_id', 'usage_limit')
-    feature_id = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='featureId')
-    usage_limit = sgqlc.types.Field(sgqlc.types.non_null(Float), graphql_name='usageLimit')
-
-
...
### Comparing `stigg_api_client-0.456.0/PKG-INFO` & `stigg_api_client-0.5.0/PKG-INFO`

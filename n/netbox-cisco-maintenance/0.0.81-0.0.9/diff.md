# Comparing `tmp/netbox-cisco-maintenance-0.0.81.tar.gz` & `tmp/netbox-cisco-maintenance-0.0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "netbox-cisco-maintenance-0.0.81.tar", last modified: Mon Jun  5 16:31:54 2023, max compression
+gzip compressed data, was "netbox-cisco-maintenance-0.0.9.tar", last modified: Fri May 19 08:37:14 2023, max compression
```

## Comparing `netbox-cisco-maintenance-0.0.81.tar` & `netbox-cisco-maintenance-0.0.9.tar`

### file list

```diff
@@ -1,34 +1,33 @@
-drwxr-xr-x   0 vsts      (1001) docker     (123)        0 2023-06-05 16:31:54.773512 netbox-cisco-maintenance-0.0.81/
--rw-r--r--   0 vsts      (1001) docker     (123)     1068 2023-06-05 16:31:37.000000 netbox-cisco-maintenance-0.0.81/LICENSE
--rw-r--r--   0 vsts      (1001) docker     (123)       62 2023-06-05 16:31:37.000000 netbox-cisco-maintenance-0.0.81/MANIFEST.in
--rw-r--r--   0 vsts      (1001) docker     (123)     5312 2023-06-05 16:31:54.773512 netbox-cisco-maintenance-0.0.81/PKG-INFO
--rw-r--r--   0 vsts      (1001) docker     (123)     4689 2023-06-05 16:31:37.000000 netbox-cisco-maintenance-0.0.81/README.md
-drwxr-xr-x   0 vsts      (1001) docker     (123)        0 2023-06-05 16:31:54.769512 netbox-cisco-maintenance-0.0.81/netbox_cisco_maintenance.egg-info/
--rw-r--r--   0 vsts      (1001) docker     (123)     5312 2023-06-05 16:31:54.000000 netbox-cisco-maintenance-0.0.81/netbox_cisco_maintenance.egg-info/PKG-INFO
--rw-r--r--   0 vsts      (1001) docker     (123)     1099 2023-06-05 16:31:54.000000 netbox-cisco-maintenance-0.0.81/netbox_cisco_maintenance.egg-info/SOURCES.txt
--rw-r--r--   0 vsts      (1001) docker     (123)        1 2023-06-05 16:31:54.000000 netbox-cisco-maintenance-0.0.81/netbox_cisco_maintenance.egg-info/dependency_links.txt
--rw-r--r--   0 vsts      (1001) docker     (123)        1 2023-06-05 16:31:54.000000 netbox-cisco-maintenance-0.0.81/netbox_cisco_maintenance.egg-info/not-zip-safe
--rw-r--r--   0 vsts      (1001) docker     (123)       28 2023-06-05 16:31:54.000000 netbox-cisco-maintenance-0.0.81/netbox_cisco_maintenance.egg-info/top_level.txt
-drwxr-xr-x   0 vsts      (1001) docker     (123)        0 2023-06-05 16:31:54.773512 netbox-cisco-maintenance-0.0.81/netbox_cisco_support_plugin/
--rw-r--r--   0 vsts      (1001) docker     (123)      562 2023-06-05 16:31:37.000000 netbox-cisco-maintenance-0.0.81/netbox_cisco_support_plugin/__init__.py
--rw-r--r--   0 vsts      (1001) docker     (123)     1024 2023-06-05 16:31:37.000000 netbox-cisco-maintenance-0.0.81/netbox_cisco_support_plugin/admin.py
-drwxr-xr-x   0 vsts      (1001) docker     (123)        0 2023-06-05 16:31:54.773512 netbox-cisco-maintenance-0.0.81/netbox_cisco_support_plugin/management/
--rw-r--r--   0 vsts      (1001) docker     (123)        0 2023-06-05 16:31:37.000000 netbox-cisco-maintenance-0.0.81/netbox_cisco_support_plugin/management/__init__.py
-drwxr-xr-x   0 vsts      (1001) docker     (123)        0 2023-06-05 16:31:54.773512 netbox-cisco-maintenance-0.0.81/netbox_cisco_support_plugin/management/commands/
--rw-r--r--   0 vsts      (1001) docker     (123)        0 2023-06-05 16:31:37.000000 netbox-cisco-maintenance-0.0.81/netbox_cisco_support_plugin/management/commands/__init__.py
--rw-r--r--   0 vsts      (1001) docker     (123)    36023 2023-06-05 16:31:37.000000 netbox-cisco-maintenance-0.0.81/netbox_cisco_support_plugin/management/commands/sync_cisco_support_data.py
-drwxr-xr-x   0 vsts      (1001) docker     (123)        0 2023-06-05 16:31:54.773512 netbox-cisco-maintenance-0.0.81/netbox_cisco_support_plugin/migrations/
--rw-r--r--   0 vsts      (1001) docker     (123)        0 2023-06-05 16:31:37.000000 netbox-cisco-maintenance-0.0.81/netbox_cisco_support_plugin/migrations/__init__.py
--rw-r--r--   0 vsts      (1001) docker     (123)     2064 2023-06-05 16:31:37.000000 netbox-cisco-maintenance-0.0.81/netbox_cisco_support_plugin/models.py
--rw-r--r--   0 vsts      (1001) docker     (123)     1826 2023-06-05 16:31:37.000000 netbox-cisco-maintenance-0.0.81/netbox_cisco_support_plugin/template_content.py
-drwxr-xr-x   0 vsts      (1001) docker     (123)        0 2023-06-05 16:31:54.769512 netbox-cisco-maintenance-0.0.81/netbox_cisco_support_plugin/templates/
-drwxr-xr-x   0 vsts      (1001) docker     (123)        0 2023-06-05 16:31:54.773512 netbox-cisco-maintenance-0.0.81/netbox_cisco_support_plugin/templates/netbox_cisco_support_plugin/
--rw-r--r--   0 vsts      (1001) docker     (123)     4261 2023-06-05 16:31:37.000000 netbox-cisco-maintenance-0.0.81/netbox_cisco_support_plugin/templates/netbox_cisco_support_plugin/cisco_support_device.html
--rw-r--r--   0 vsts      (1001) docker     (123)     3312 2023-06-05 16:31:37.000000 netbox-cisco-maintenance-0.0.81/netbox_cisco_support_plugin/templates/netbox_cisco_support_plugin/cisco_support_device_type.html
--rw-r--r--   0 vsts      (1001) docker     (123)      179 2023-06-05 16:31:37.000000 netbox-cisco-maintenance-0.0.81/netbox_cisco_support_plugin/templates/netbox_cisco_support_plugin/no_data_available.html
-drwxr-xr-x   0 vsts      (1001) docker     (123)        0 2023-06-05 16:31:54.773512 netbox-cisco-maintenance-0.0.81/netbox_cisco_support_plugin/templatetags/
--rw-r--r--   0 vsts      (1001) docker     (123)        0 2023-06-05 16:31:37.000000 netbox-cisco-maintenance-0.0.81/netbox_cisco_support_plugin/templatetags/__init__.py
--rw-r--r--   0 vsts      (1001) docker     (123)     1215 2023-06-05 16:31:37.000000 netbox-cisco-maintenance-0.0.81/netbox_cisco_support_plugin/templatetags/filters.py
--rw-r--r--   0 vsts      (1001) docker     (123)       23 2023-06-05 16:31:37.000000 netbox-cisco-maintenance-0.0.81/netbox_cisco_support_plugin/version.py
--rw-r--r--   0 vsts      (1001) docker     (123)       38 2023-06-05 16:31:54.773512 netbox-cisco-maintenance-0.0.81/setup.cfg
--rw-r--r--   0 vsts      (1001) docker     (123)     1544 2023-06-05 16:31:37.000000 netbox-cisco-maintenance-0.0.81/setup.py
...
### Comparing `netbox-cisco-maintenance-0.0.81/LICENSE` & `netbox-cisco-maintenance-0.0.9/LICENSE`

 * *Files identical despite different names*

### Comparing `netbox-cisco-maintenance-0.0.81/PKG-INFO` & `netbox-cisco-maintenance-0.0.9/PKG-INFO`
...
### Comparing `netbox-cisco-maintenance-0.0.81/README.md` & `netbox-cisco-maintenance-0.0.9/README.md`
...
### Comparing `netbox-cisco-maintenance-0.0.81/netbox_cisco_maintenance.egg-info/PKG-INFO` & `netbox-cisco-maintenance-0.0.9/netbox_cisco_maintenance.egg-info/PKG-INFO`
...
### Comparing `netbox-cisco-maintenance-0.0.81/netbox_cisco_maintenance.egg-info/SOURCES.txt` & `netbox-cisco-maintenance-0.0.9/netbox_cisco_maintenance.egg-info/SOURCES.txt`
...
### Comparing `netbox-cisco-maintenance-0.0.81/netbox_cisco_support_plugin/__init__.py` & `netbox-cisco-maintenance-0.0.9/netbox_cisco_maintenance/__init__.py`
...
### Comparing `netbox-cisco-maintenance-0.0.81/netbox_cisco_support_plugin/template_content.py` & `netbox-cisco-maintenance-0.0.9/netbox_cisco_maintenance/template_content.py`
...
### Comparing `netbox-cisco-maintenance-0.0.81/netbox_cisco_support_plugin/templates/netbox_cisco_support_plugin/cisco_support_device_type.html` & `netbox-cisco-maintenance-0.0.9/netbox_cisco_maintenance/templates/netbox_cisco_maintenance/cisco_support_device_type.html`
...
-                {% elif cisco_device_type_support.eox_error is None %}
...
### Comparing `netbox-cisco-maintenance-0.0.81/netbox_cisco_support_plugin/templatetags/filters.py` & `netbox-cisco-maintenance-0.0.9/netbox_cisco_maintenance/templatetags/filters.py`
...
### Comparing `netbox-cisco-maintenance-0.0.81/setup.py` & `netbox-cisco-maintenance-0.0.9/setup.py`

# Comparing `tmp/netbox-cisco-maintenance-0.0.87.tar.gz` & `tmp/netbox-cisco-maintenance-0.0.9.tar.gz`
...
### Comparing `netbox-cisco-maintenance-0.0.87/setup.py` & `netbox-cisco-maintenance-0.0.9/setup.py`

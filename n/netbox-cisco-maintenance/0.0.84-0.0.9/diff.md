# Comparing `tmp/netbox-cisco-maintenance-0.0.84.tar.gz` & `tmp/netbox-cisco-maintenance-0.0.9.tar.gz`
...
### Comparing `netbox-cisco-maintenance-0.0.84/setup.py` & `netbox-cisco-maintenance-0.0.9/setup.py`

# Comparing `tmp/neo4cdisc-1.0.5.0.tar.gz` & `tmp/neo4cdisc-1.0.5.1.tar.gz`
...
## Comparing `neo4cdisc-1.0.5.0.tar` & `neo4cdisc-1.0.5.1.tar`
...
### Comparing `neo4cdisc-1.0.5.0/LICENSE` & `neo4cdisc-1.0.5.1/LICENSE`

 * *Files identical despite different names*

### Comparing `neo4cdisc-1.0.5.0/PKG-INFO` & `neo4cdisc-1.0.5.1/PKG-INFO`
...
### Comparing `neo4cdisc-1.0.5.0/README.md` & `neo4cdisc-1.0.5.1/README.md`

 * *Files identical despite different names*

### Comparing `neo4cdisc-1.0.5.0/cdisc_data_providers/sdtm_data_provider.py` & `neo4cdisc-1.0.5.1/cdisc_data_providers/sdtm_data_provider.py`

 * *Files identical despite different names*

### Comparing `neo4cdisc-1.0.5.0/cdisc_model_managers/cdisc_api.py` & `neo4cdisc-1.0.5.1/cdisc_model_managers/cdisc_api.py`

 * *Files identical despite different names*

### Comparing `neo4cdisc-1.0.5.0/cdisc_model_managers/cdisc_model_manager.py` & `neo4cdisc-1.0.5.1/cdisc_model_managers/cdisc_model_manager.py`

 * *Files identical despite different names*

### Comparing `neo4cdisc-1.0.5.0/cdisc_model_managers/cdisc_standard_loader.py` & `neo4cdisc-1.0.5.1/cdisc_model_managers/cdisc_standard_loader.py`

 * *Files identical despite different names*

### Comparing `neo4cdisc-1.0.5.0/neo4cdisc.egg-info/PKG-INFO` & `neo4cdisc-1.0.5.1/neo4cdisc.egg-info/PKG-INFO`
...
### Comparing `neo4cdisc-1.0.5.0/neo4cdisc.egg-info/SOURCES.txt` & `neo4cdisc-1.0.5.1/neo4cdisc.egg-info/SOURCES.txt`
...
-requirements.txt
 setup.py
 cdisc_data_providers/__init__.py
 cdisc_data_providers/sdtm_data_provider.py
 cdisc_model_managers/__init__.py
 cdisc_model_managers/cdisc_api.py
 cdisc_model_managers/cdisc_model_manager.py
 cdisc_model_managers/cdisc_standard_loader.py
```

### Comparing `neo4cdisc-1.0.5.0/setup.py` & `neo4cdisc-1.0.5.1/setup.py`
...
### Comparing `neo4cdisc-1.0.5.0/tests/test_cdisc_model_manager.py` & `neo4cdisc-1.0.5.1/tests/test_cdisc_model_manager.py`

 * *Files identical despite different names*

### Comparing `neo4cdisc-1.0.5.0/tests/test_sdtm_data_provider.py` & `neo4cdisc-1.0.5.1/tests/test_sdtm_data_provider.py`

 * *Files identical despite different names*

### Comparing `neo4cdisc-1.0.5.0/tests/test_sdtm_data_provider_dfcheck.py` & `neo4cdisc-1.0.5.1/tests/test_sdtm_data_provider_dfcheck.py`

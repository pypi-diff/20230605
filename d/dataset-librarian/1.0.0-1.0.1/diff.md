# Comparing `tmp/dataset_librarian-1.0.0.tar.gz` & `tmp/dataset_librarian-1.0.1.tar.gz`
...
## Comparing `dataset_librarian-1.0.0.tar` & `dataset_librarian-1.0.1.tar`
...
### Comparing `dataset_librarian-1.0.0/PKG-INFO` & `dataset_librarian-1.0.1/PKG-INFO`
...
### Comparing `dataset_librarian-1.0.0/README.md` & `dataset_librarian-1.0.1/README.md`

 * *Files identical despite different names*

### Comparing `dataset_librarian-1.0.0/pyproject.toml` & `dataset_librarian-1.0.1/pyproject.toml`
...
### Comparing `dataset_librarian-1.0.0/src/dataset_librarian/__init__.py` & `dataset_librarian-1.0.1/src/dataset_librarian/__init__.py`

 * *Files identical despite different names*

### Comparing `dataset_librarian-1.0.0/src/dataset_librarian/dataset.py` & `dataset_librarian-1.0.1/src/dataset_librarian/dataset.py`

 * *Files identical despite different names*

### Comparing `dataset_librarian-1.0.0/src/dataset_librarian/dataset_api/__init__.py` & `dataset_librarian-1.0.1/src/dataset_librarian/dataset_api/__init__.py`

 * *Files identical despite different names*

### Comparing `dataset_librarian-1.0.0/src/dataset_librarian/dataset_api/download.py` & `dataset_librarian-1.0.1/src/dataset_librarian/dataset_api/download.py`

 * *Files identical despite different names*

### Comparing `dataset_librarian-1.0.0/src/dataset_librarian/dataset_api/preprocess.py` & `dataset_librarian-1.0.1/src/dataset_librarian/dataset_api/preprocess.py`

 * *Files identical despite different names*

### Comparing `dataset_librarian-1.0.0/src/dataset_librarian/datasets_urls.json` & `dataset_librarian-1.0.1/src/dataset_librarian/datasets_urls.json`

 * *Files identical despite different names*

### Comparing `dataset_librarian-1.0.0/src/dataset_librarian/scripts/__init__.py` & `dataset_librarian-1.0.1/src/dataset_librarian/scripts/__init__.py`

 * *Files identical despite different names*

### Comparing `dataset_librarian-1.0.0/src/dataset_librarian/scripts/brca/__init__.py` & `dataset_librarian-1.0.1/src/dataset_librarian/scripts/brca/__init__.py`

 * *Files identical despite different names*

### Comparing `dataset_librarian-1.0.0/src/dataset_librarian/scripts/brca/prepare_nlp_data.py` & `dataset_librarian-1.0.1/src/dataset_librarian/scripts/brca/prepare_nlp_data.py`

 * *Files identical despite different names*

### Comparing `dataset_librarian-1.0.0/src/dataset_librarian/scripts/brca/prepare_vision_data.py` & `dataset_librarian-1.0.1/src/dataset_librarian/scripts/brca/prepare_vision_data.py`

 * *Files identical despite different names*

### Comparing `dataset_librarian-1.0.0/src/dataset_librarian/scripts/mvtec-ad/__init__.py` & `dataset_librarian-1.0.1/src/dataset_librarian/scripts/mvtec-ad/__init__.py`

 * *Files identical despite different names*

### Comparing `dataset_librarian-1.0.0/src/dataset_librarian/scripts/mvtec-ad/csv_generator_mvtec.py` & `dataset_librarian-1.0.1/src/dataset_librarian/scripts/mvtec-ad/csv_generator_mvtec.py`

 * *Files identical despite different names*

### Comparing `dataset_librarian-1.0.0/src/dataset_librarian/terms_and_conditions.txt` & `dataset_librarian-1.0.1/src/dataset_librarian/terms_and_conditions.txt`

 * *Files identical despite different names*

### Comparing `dataset_librarian-1.0.0/src/dataset_librarian.egg-info/PKG-INFO` & `dataset_librarian-1.0.1/src/dataset_librarian.egg-info/PKG-INFO`
...
### Comparing `dataset_librarian-1.0.0/src/dataset_librarian.egg-info/SOURCES.txt` & `dataset_librarian-1.0.1/src/dataset_librarian.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `dataset_librarian-1.0.0/third-party-programs.txt` & `dataset_librarian-1.0.1/third-party-programs.txt`

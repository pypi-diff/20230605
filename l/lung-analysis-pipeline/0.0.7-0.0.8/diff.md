# Comparing `tmp/lung_analysis_pipeline-0.0.7.tar.gz` & `tmp/lung_analysis_pipeline-0.0.8.tar.gz`
...
### Comparing `lung_analysis_pipeline-0.0.7/lung_analysis_pipeline/Normalization_Pipeline/codes/models/SRGAN_exp.py` & `lung_analysis_pipeline-0.0.8/lung_analysis_pipeline/Normalization_Pipeline/codes/models/SRGAN_exp.py`

 * *Files identical despite different names*

### Comparing `lung_analysis_pipeline-0.0.7/lung_analysis_pipeline/Normalization_Pipeline/codes/models/__init__.py` & `lung_analysis_pipeline-0.0.8/lung_analysis_pipeline/Normalization_Pipeline/codes/models/__init__.py`

 * *Files identical despite different names*

### Comparing `lung_analysis_pipeline-0.0.7/lung_analysis_pipeline/Normalization_Pipeline/codes/models/base_model.py` & `lung_analysis_pipeline-0.0.8/lung_analysis_pipeline/Normalization_Pipeline/codes/models/base_model.py`

 * *Files identical despite different names*

### Comparing `lung_analysis_pipeline-0.0.7/lung_analysis_pipeline/Normalization_Pipeline/codes/PerceptualSimilarity/compute_dists.py` & `lung_analysis_pipeline-0.0.8/lung_analysis_pipeline/Normalization_Pipeline/codes/PerceptualSimilarity/compute_dists.py`

 * *Files identical despite different names*

### Comparing `lung_analysis_pipeline-0.0.7/lung_analysis_pipeline/Normalization_Pipeline/codes/PerceptualSimilarity/util/html.py` & `lung_analysis_pipeline-0.0.8/lung_analysis_pipeline/Normalization_Pipeline/codes/PerceptualSimilarity/util/html.py`

 * *Files identical despite different names*

### Comparing `lung_analysis_pipeline-0.0.7/lung_analysis_pipeline/Normalization_Pipeline/codes/PerceptualSimilarity/util/util.py` & `lung_analysis_pipeline-0.0.8/lung_analysis_pipeline/Normalization_Pipeline/codes/PerceptualSimilarity/util/util.py`

 * *Files identical despite different names*

### Comparing `lung_analysis_pipeline-0.0.7/lung_analysis_pipeline/Normalization_Pipeline/codes/PerceptualSimilarity/util/visualizer.py` & `lung_analysis_pipeline-0.0.8/lung_analysis_pipeline/Normalization_Pipeline/codes/PerceptualSimilarity/util/visualizer.py`

 * *Files identical despite different names*

### Comparing `lung_analysis_pipeline-0.0.7/lung_analysis_pipeline/Normalization_Pipeline/codes/PerceptualSimilarity/compute_dists_dirs.py` & `lung_analysis_pipeline-0.0.8/lung_analysis_pipeline/Normalization_Pipeline/codes/PerceptualSimilarity/compute_dists_dirs.py`

 * *Files identical despite different names*

### Comparing `lung_analysis_pipeline-0.0.7/lung_analysis_pipeline/Normalization_Pipeline/codes/PerceptualSimilarity/models/pretrained_networks.py` & `lung_analysis_pipeline-0.0.8/lung_analysis_pipeline/Normalization_Pipeline/codes/PerceptualSimilarity/models/pretrained_networks.py`

 * *Files identical despite different names*

### Comparing `lung_analysis_pipeline-0.0.7/lung_analysis_pipeline/Normalization_Pipeline/codes/PerceptualSimilarity/models/dist_model.py` & `lung_analysis_pipeline-0.0.8/lung_analysis_pipeline/Normalization_Pipeline/codes/PerceptualSimilarity/models/dist_model.py`

 * *Files identical despite different names*

### Comparing `lung_analysis_pipeline-0.0.7/lung_analysis_pipeline/Normalization_Pipeline/codes/PerceptualSimilarity/models/networks_basic.py` & `lung_analysis_pipeline-0.0.8/lung_analysis_pipeline/Normalization_Pipeline/codes/PerceptualSimilarity/models/networks_basic.py`

 * *Files identical despite different names*

### Comparing `lung_analysis_pipeline-0.0.7/lung_analysis_pipeline/Normalization_Pipeline/codes/PerceptualSimilarity/models/base_model.py` & `lung_analysis_pipeline-0.0.8/lung_analysis_pipeline/Normalization_Pipeline/codes/PerceptualSimilarity/models/base_model.py`

 * *Files identical despite different names*

### Comparing `lung_analysis_pipeline-0.0.7/lung_analysis_pipeline/Normalization_Pipeline/codes/test.py` & `lung_analysis_pipeline-0.0.8/lung_analysis_pipeline/Normalization_Pipeline/codes/test.py`

 * *Files identical despite different names*

### Comparing `lung_analysis_pipeline-0.0.7/lung_analysis_pipeline/utils/util.py` & `lung_analysis_pipeline-0.0.8/lung_analysis_pipeline/utils/util.py`

 * *Files identical despite different names*

### Comparing `lung_analysis_pipeline-0.0.7/lung_analysis_pipeline/utils/patch.py` & `lung_analysis_pipeline-0.0.8/lung_analysis_pipeline/utils/patch.py`

 * *Files identical despite different names*

### Comparing `lung_analysis_pipeline-0.0.7/lung_analysis_pipeline/NoduleSeg_MedicalNet/train_unet_lidc.py` & `lung_analysis_pipeline-0.0.8/lung_analysis_pipeline/NoduleSeg_MedicalNet/train_unet_lidc.py`

 * *Files identical despite different names*

### Comparing `lung_analysis_pipeline-0.0.7/lung_analysis_pipeline/NoduleSeg_MedicalNet/test_unet_lidc.py` & `lung_analysis_pipeline-0.0.8/lung_analysis_pipeline/NoduleSeg_MedicalNet/test_unet_lidc.py`

 * *Files identical despite different names*

### Comparing `lung_analysis_pipeline-0.0.7/lung_analysis_pipeline/NoduleSeg_MedicalNet/test_resnet34_lidc.py` & `lung_analysis_pipeline-0.0.8/lung_analysis_pipeline/NoduleSeg_MedicalNet/test_resnet34_lidc.py`

 * *Files identical despite different names*

### Comparing `lung_analysis_pipeline-0.0.7/lung_analysis_pipeline/NoduleSeg_MedicalNet/train.py` & `lung_analysis_pipeline-0.0.8/lung_analysis_pipeline/NoduleSeg_MedicalNet/train.py`

 * *Files identical despite different names*

### Comparing `lung_analysis_pipeline-0.0.7/lung_analysis_pipeline/NoduleSeg_MedicalNet/setting.py` & `lung_analysis_pipeline-0.0.8/lung_analysis_pipeline/NoduleSeg_MedicalNet/setting.py`

 * *Files identical despite different names*

### Comparing `lung_analysis_pipeline-0.0.7/lung_analysis_pipeline/NoduleSeg_MedicalNet/model.py` & `lung_analysis_pipeline-0.0.8/lung_analysis_pipeline/NoduleSeg_MedicalNet/model.py`

 * *Files identical despite different names*

### Comparing `lung_analysis_pipeline-0.0.7/lung_analysis_pipeline/NoduleSeg_MedicalNet/build_unet_model.py` & `lung_analysis_pipeline-0.0.8/lung_analysis_pipeline/NoduleSeg_MedicalNet/build_unet_model.py`

 * *Files identical despite different names*

### Comparing `lung_analysis_pipeline-0.0.7/lung_analysis_pipeline/NoduleSeg_MedicalNet/test.py` & `lung_analysis_pipeline-0.0.8/lung_analysis_pipeline/NoduleSeg_MedicalNet/test.py`

 * *Files identical despite different names*

### Comparing `lung_analysis_pipeline-0.0.7/lung_analysis_pipeline/NoduleSeg_MedicalNet/test_unet_norm.py` & `lung_analysis_pipeline-0.0.8/lung_analysis_pipeline/NoduleSeg_MedicalNet/test_unet_norm.py`

 * *Files identical despite different names*

### Comparing `lung_analysis_pipeline-0.0.7/lung_analysis_pipeline/model_pipeline.py` & `lung_analysis_pipeline-0.0.8/lung_analysis_pipeline/model_pipeline.py`

 * *Files identical despite different names*

### Comparing `lung_analysis_pipeline-0.0.7/lung_analysis_pipeline/__init__.py` & `lung_analysis_pipeline-0.0.8/lung_analysis_pipeline/__init__.py`

 * *Files identical despite different names*

### Comparing `lung_analysis_pipeline-0.0.7/lung_analysis_pipeline.egg-info/SOURCES.txt` & `lung_analysis_pipeline-0.0.8/lung_analysis_pipeline.egg-info/SOURCES.txt`

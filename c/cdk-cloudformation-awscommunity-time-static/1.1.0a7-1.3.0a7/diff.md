# Comparing `tmp/cdk-cloudformation-awscommunity-time-static-1.1.0a7.tar.gz` & `tmp/cdk-cloudformation-awscommunity-time-static-1.3.0a7.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "/__w/cdk-cloudformation/cdk-cloudformation/packages/@cdk-cloudformation/awscommunity-time-static/dist/python/cdk-cloudformation", last modified: Mon May  8 06:13:05 2023, max compression
...
## Comparing `cdk-cloudformation-awscommunity-time-static-1.1.0a7.tar` & `cdk-cloudformation-awscommunity-time-static-1.3.0a7.tar`

### file list

```diff
@@ -1,21 +1,21 @@
-drwxr-xr-x   0 superchain  (1001) superchain  (1001)        0 2023-05-08 06:13:05.000000 cdk-cloudformation-awscommunity-time-static-1.1.0a7/
--rw-r--r--   0 superchain  (1001) superchain  (1001)    11358 2023-05-08 06:13:00.000000 cdk-cloudformation-awscommunity-time-static-1.1.0a7/LICENSE
--rw-r--r--   0 superchain  (1001) superchain  (1001)       23 2023-05-08 06:13:00.000000 cdk-cloudformation-awscommunity-time-static-1.1.0a7/MANIFEST.in
--rw-r--r--   0 superchain  (1001) superchain  (1001)     2981 2023-05-08 06:13:05.000000 cdk-cloudformation-awscommunity-time-static-1.1.0a7/PKG-INFO
--rw-r--r--   0 superchain  (1001) superchain  (1001)     2031 2023-05-08 06:13:00.000000 cdk-cloudformation-awscommunity-time-static-1.1.0a7/README.md
--rw-r--r--   0 superchain  (1001) superchain  (1001)      234 2023-05-08 06:13:00.000000 cdk-cloudformation-awscommunity-time-static-1.1.0a7/pyproject.toml
--rw-r--r--   0 superchain  (1001) superchain  (1001)       38 2023-05-08 06:13:05.000000 cdk-cloudformation-awscommunity-time-static-1.1.0a7/setup.cfg
--rw-r--r--   0 superchain  (1001) superchain  (1001)     1930 2023-05-08 06:13:00.000000 cdk-cloudformation-awscommunity-time-static-1.1.0a7/setup.py
-drwxr-xr-x   0 superchain  (1001) superchain  (1001)        0 2023-05-08 06:13:05.000000 cdk-cloudformation-awscommunity-time-static-1.1.0a7/src/
-drwxr-xr-x   0 superchain  (1001) superchain  (1001)        0 2023-05-08 06:13:05.000000 cdk-cloudformation-awscommunity-time-static-1.1.0a7/src/cdk_cloudformation_awscommunity_time_static/
--rw-r--r--   0 superchain  (1001) superchain  (1001)     9313 2023-05-08 06:13:00.000000 cdk-cloudformation-awscommunity-time-static-1.1.0a7/src/cdk_cloudformation_awscommunity_time_static/__init__.py
-drwxr-xr-x   0 superchain  (1001) superchain  (1001)        0 2023-05-08 06:13:05.000000 cdk-cloudformation-awscommunity-time-static-1.1.0a7/src/cdk_cloudformation_awscommunity_time_static/_jsii/
--rw-r--r--   0 superchain  (1001) superchain  (1001)      464 2023-05-08 06:13:00.000000 cdk-cloudformation-awscommunity-time-static-1.1.0a7/src/cdk_cloudformation_awscommunity_time_static/_jsii/__init__.py
--rw-r--r--   0 superchain  (1001) superchain  (1001)    18141 2023-05-08 06:13:00.000000 cdk-cloudformation-awscommunity-time-static-1.1.0a7/src/cdk_cloudformation_awscommunity_time_static/_jsii/awscommunity-time-static@1.1.0-alpha.7.jsii.tgz
--rw-r--r--   0 superchain  (1001) superchain  (1001)        1 2023-05-08 06:13:00.000000 cdk-cloudformation-awscommunity-time-static-1.1.0a7/src/cdk_cloudformation_awscommunity_time_static/py.typed
-drwxr-xr-x   0 superchain  (1001) superchain  (1001)        0 2023-05-08 06:13:05.000000 cdk-cloudformation-awscommunity-time-static-1.1.0a7/src/cdk_cloudformation_awscommunity_time_static.egg-info/
--rw-r--r--   0 superchain  (1001) superchain  (1001)     2981 2023-05-08 06:13:05.000000 cdk-cloudformation-awscommunity-time-static-1.1.0a7/src/cdk_cloudformation_awscommunity_time_static.egg-info/PKG-INFO
--rw-r--r--   0 superchain  (1001) superchain  (1001)      692 2023-05-08 06:13:05.000000 cdk-cloudformation-awscommunity-time-static-1.1.0a7/src/cdk_cloudformation_awscommunity_time_static.egg-info/SOURCES.txt
--rw-r--r--   0 superchain  (1001) superchain  (1001)        1 2023-05-08 06:13:05.000000 cdk-cloudformation-awscommunity-time-static-1.1.0a7/src/cdk_cloudformation_awscommunity_time_static.egg-info/dependency_links.txt
--rw-r--r--   0 superchain  (1001) superchain  (1001)      112 2023-05-08 06:13:05.000000 cdk-cloudformation-awscommunity-time-static-1.1.0a7/src/cdk_cloudformation_awscommunity_time_static.egg-info/requires.txt
--rw-r--r--   0 superchain  (1001) superchain  (1001)       44 2023-05-08 06:13:05.000000 cdk-cloudformation-awscommunity-time-static-1.1.0a7/src/cdk_cloudformation_awscommunity_time_static.egg-info/top_level.txt
...
### Comparing `cdk-cloudformation-awscommunity-time-static-1.1.0a7/LICENSE` & `cdk-cloudformation-awscommunity-time-static-1.3.0a7/LICENSE`

 * *Files identical despite different names*

### Comparing `cdk-cloudformation-awscommunity-time-static-1.1.0a7/PKG-INFO` & `cdk-cloudformation-awscommunity-time-static-1.3.0a7/PKG-INFO`
...
-> AWS CDK [L1 construct](https://docs.aws.amazon.com/cdk/latest/guide/constructs.html) and data structures for the [AWS CloudFormation Registry](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/registry.html) type `AwsCommunity::Time::Static` v1.1.0.
...
### Comparing `cdk-cloudformation-awscommunity-time-static-1.1.0a7/README.md` & `cdk-cloudformation-awscommunity-time-static-1.3.0a7/README.md`
...
### Comparing `cdk-cloudformation-awscommunity-time-static-1.1.0a7/setup.py` & `cdk-cloudformation-awscommunity-time-static-1.3.0a7/setup.py`
...
@@ -22,25 +22,25 @@
     ...
     "package_data": {
         "cdk_cloudformation_awscommunity_time_static._jsii": [
-            "awscommunity-time-static@1.1.0-alpha.7.jsii.tgz"
...
### Comparing `cdk-cloudformation-awscommunity-time-static-1.1.0a7/src/cdk_cloudformation_awscommunity_time_static/__init__.py` & `cdk-cloudformation-awscommunity-time-static-1.3.0a7/src/cdk_cloudformation_awscommunity_time_static/__init__.py`
...
### Comparing `cdk-cloudformation-awscommunity-time-static-1.1.0a7/src/cdk_cloudformation_awscommunity_time_static.egg-info/PKG-INFO` & `cdk-cloudformation-awscommunity-time-static-1.3.0a7/src/cdk_cloudformation_awscommunity_time_static.egg-info/PKG-INFO`
...
### Comparing `cdk-cloudformation-awscommunity-time-static-1.1.0a7/src/cdk_cloudformation_awscommunity_time_static.egg-info/SOURCES.txt` & `cdk-cloudformation-awscommunity-time-static-1.3.0a7/src/cdk_cloudformation_awscommunity_time_static.egg-info/SOURCES.txt`
...
-src/cdk_cloudformation_awscommunity_time_static/_jsii/awscommunity-time-static@1.1.0-alpha.7.jsii.tgz
